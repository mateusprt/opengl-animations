...
int main()
{
    ...
    // Criando as sprites
    jogador = new Sprite(carregarTextura("../player.png"), vec3(400.0f, 150.0f, 0.0f), vec3(128.0f, 128.0f, 1.0f), &shader, 4.0, 180.0f);
    cenario = new Sprite(carregarTextura("../background.png"), vec3(400.0f, 300.0f, 0.0f), vec3(960.0f, 540.0f, 1.0f), &shader, 0.0, 180.0f);
